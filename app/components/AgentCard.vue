...
<template>
  <NuxtLink
    ...
    class="block rounded-lg p-4 transition-all duration-200 focus-ring group relative overflow-hidden"
  ...
  >
    ...
    <div class="flex items-start gap-3 relative">
      <div
        class="size-8 rounded-md flex items-center justify-center shrink-0 mt-0.5 transition-transform duration-200 group-hover:scale-105"
